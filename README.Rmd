...
To use this template click on teh use this template button and then select create a new repository. This will generate a new repository with the same structure as the template. 
